...
import IMAGE from '../assets/icons/mdn-info2.png'
...
export default function Skills() {
   return (
      <div className=" my-10 transition-all duration-300 bg-slate-200 text-slate-900">
         <h1 className="text-6xl my-5 p-5 font-semibold">My skills</h1>
         <div className="flex items-center justify-center">
            <img className="w-[30em] h-[20em] rounded-full" src={IMAGE} alt="" />
         </div>
